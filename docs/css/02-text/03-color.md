...
=== "Color"
    ...
    !!! tip "Guía: Paleta de colores"
        ...
        |---|---|---|
        |**Principal:** Resalta partes importantes<br>**Claros y Oscuros:** Crea contraste|Añade variedad||
        |Usado en elementos dominantes:<br>• Botones<br>• Colores de fondo<br>• Iconos|Mismos usos que el primario|Usado en fuentes|
